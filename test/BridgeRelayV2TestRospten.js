...
describe("MAPBridgeV2", () => {
  before(async function (){
    ...
    this.bridge = await ethers.getContractAt('MAPBridgeRelayV2','0x6cAFce6AdAB4eeeb3d5c93073B64A3372E689F06');
  ...
  it("MAPBridgeV2", async function () {
    ...
    //
    // await feeCenter.setChainTokenGasFee(3,"0xf70949bc9b52deffcda63b0d15608d601e3a7c49",1,10000,100);
    // await feeCenter.setChainTokenGasFee(3,this.mintToken.address,1,10000,100);
    // await feeCenter.setChainTokenGasFee(3,this.usdt.address,1,10000,100);
    //
    ...
    // // function transferIn(address token, address from, address payable to, uint amount, bytes32 orderId, uint fromChain, uint toChain)
    // await this.bridge.transferIn(this.usdt.address,this.deployer.address,
    //     this.deployer.address,amount,'0x84b58192d78af4b8e92894444016ae129640ce3e2d41a02ebfebc3df7dafa017',1,3)
    // console.log("transferInToken self is ok")
    //
    // await this.bridge.transferIn(this.mintToken.address,this.deployer.address,
    //     this.deployer.address,amount,'0x84b58192d78af4b8e92894444016ae129640ce3e2d41a02ebfebc3df7dafa012',1,3)
    // console.log("transferInTokenMint self is ok")
    //
    // await this.bridge.transferIn("0x0000000000000000000000000000000000000000",this.deployer.address,
    //     this.deployer.address,"1000",'0x84b58192d78af4b8e92894444016ae129640ce3e2d41a02ebfebc3df7dafa013',1,3)
